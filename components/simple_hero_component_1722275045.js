...
*/
Vue.component("simple_hero_component_1722275045", {
    template: `
            ...
            <div id="hero-container" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7">
                    ...
                    <div id="hero-subtitle-container" class="flex">
                        <p id="hero-subtitle" class="flex-1 max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Harness the Power of Decentralized Data Analysis</p>
                    </div>
                    ...
                    <div id="hello-world-button-container" class="flex mt-4">
                        <button id="hello-world-button" class="flex-1 items-center justify-center px-5 py-3 text-sm font-medium text-white bg-purple-600 rounded-lg hover:bg-purple-700 focus:ring-4 focus:ring-purple-300 dark:focus:ring-purple-800">
                            Hello World
                        </button>
                    </div>

                    <div id="hello-world-button-container" class="flex mt-4">
                        <button id="hello-world-button" class="flex-1 items-center justify-center px-5 py-3 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800">
                            Hello World
                        </button>
                    </div>
