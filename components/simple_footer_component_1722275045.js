...
*/
Vue.component("simple_footer_component_1722275045", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            DecentraLedger - Blockchain Analytics Platform
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Gain real-time insights into blockchain data with DecentraLedger's powerful analytics engine. Our decentralized platform provides transparent and secure access to on-chain activity across major blockchain networks.
                    </div>
                </div>
            </div>
        </footer> 
